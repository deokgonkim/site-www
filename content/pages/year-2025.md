...
- Dec 2025
  - Create a new site [flea.dgkim.net](https://flea.dgkim.net/)
    - NextJS, Turborepo, Serverless, AWS DynamoDB, *Telegram for messaging*
    - Used [Codex](https://openai.com/codex/) to scaffold the project and design/implement core pages.
  - Published notion template for sale [Fountain pen inking](https://www.notion.com/templates/fountain-pen-inking)
  - *Started using [Conky](https://github.com/brndnmtthws/conky)*
  - *Disposed HP LJ 1022*
